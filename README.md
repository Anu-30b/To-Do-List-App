To Do List is an android app which is used for the user to add their daily tasks. In this app user can add the new task, edit the existing task and can delete the task.
